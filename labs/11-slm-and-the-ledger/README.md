# Phase 11 — does the fine-tune beat the boring baseline?
...
Before you rent a GPU, two things. Work out what it will cost — properly, line by line, in
memory. And write down what result would make you *not* rent it.
